...
const IQGeoDockerfiles = require('./iqgeo-dockerfiles');
...
class IQGeoVSCode {
    constructor(context) {
        ...
        this.dockerfiles = new IQGeoDockerfiles(this);
        ...
        context.subscriptions.push(
            vscode.commands.registerCommand('iqgeo.updateDockerfiles', () => this.dockerfiles.update())
        );
